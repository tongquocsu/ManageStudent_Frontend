...
const tableDate = [
  {
    ...
    information: <Link to="/teacher/studentProfile"><i className="fa-solid fa-eye text-[#00ff00]"></i></Link>,
  ...
  return (
    <div>
      ...
      <Table dataSource={tableDate} pagnination={false} bordered>
        ...
        <Column className="text-center" title="Phản ánh" dataIndex="evaluate" />
